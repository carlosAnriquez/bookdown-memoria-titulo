...
readRDS(url("https://github.com/carlosAnriquez/bookdown-memoria-titulo/blob/main/input/df_analysis.RData"))
...
levels(df_analysis$f05_03_w06)[levels(df_analysis$f05_03_w06r) == "Nunca se justifica"] <- "Nunca"
levels(df_analysis$f05_03_w06)[levels(df_analysis$f05_03_w06) == "Pocas veces se justifica"] <- "Pocas veces"
levels(df_analysis$f05_03_w06)[levels(df_analysis$f05_03_w06) == "Algunas veces se justifica"] <- "Algunas veces"
levels(df_analysis$f05_03_w06)[levels(df_analysis$f05_03_w06) == "Muchas veces se justifica"] <- "Muchas veces"
levels(df_analysis$f05_03_w06)[levels(df_analysis$f05_03_w06) == "Siempre se justifica"] <- "Siempre"
